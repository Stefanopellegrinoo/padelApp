...
--
-- Delta contra 0032, y nada más: dos guards antes del update. El resto sigue
-- byte a byte igual.
--
-- CUIDADO al re-copiar: `0025` define DOS funciones y copiar "hasta el final
-- del archivo" revierte `0026` en silencio (pasó al escribir `0031`). Esta
-- migración define UNA — lo fija `db/migrations.unit.test.ts`.
